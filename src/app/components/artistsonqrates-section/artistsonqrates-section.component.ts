...
export class ArtistsonqratesSectionComponent {
  items = [
    ...
    },
    {
      ...
      quote:
        "Vinyl has a soul. The crackles and pops, the warmth of the sound—it's like the music is alive. Releasing this album on vinyl felt like giving it a new life.",
      color: '#87CEEB',
    },
    {
      image: 'images/artist3.png',
      quote:
        "Seeing fans hold the vinyl in their hands, flipping through the artwork, and placing the needle on the record—it's a connection that digital just can't replicate.",
      color: '#98FB98',
    },
  ];
